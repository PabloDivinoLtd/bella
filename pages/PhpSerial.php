...
class PhpSerial
{
    ...
    public function deviceSet($device)
    {
        if ($this->_dState !== SERIAL_DEVICE_OPENED) {
            ...
            ?>
            <script type='text/javascript'>alert(" Cannot Register. Please check the Fingerprint Scanner. The device must be set before to be open ");</script>
            <?php
            //trigger_error("Cannot Register. Please check the Fingerprint Scanner.", E_USER_WARNING);
