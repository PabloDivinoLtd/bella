...
if(isset($_GET['msg']) && ($_GET['msg']=="added")){
                ?>
                <script type='text/javascript'>alert("Insurer Successfully Registered");</script>
                <?php
            }
  if(isset($_POST['submit'])){
  include('../config/DbFunction.php');
	$obj=new DbFunction();
	$obj->addInsurer($_POST['name'],$_POST['address']);
}
	?>
<!DOCTYPE html>
<html lang="en">
...
<form method="post" >
	...
	<input type="submit" class="btn btn-primary" name="submit" value="Add Insurer"></button>
											</div>
										</div>
				</div>
					</div>
